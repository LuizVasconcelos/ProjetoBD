            ...
            <tbody>
              ...
              foreach($suppliers as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="' . site_url() . 'suppliers/update/' . $row['cnpj'] . '" class="btn btn-info">ver e editar</a>
                  <a href="' . site_url() . 'suppliers/update/' . $row['cnpj'] . '" class="btn btn-danger">remover</a>
                </td>';
                echo '</tr>';
              }
              ?>
